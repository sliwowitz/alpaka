...
namespace alpaka
{
    namespace rand
    {
        ...
        public:
            using EngineParams
                = engine::PhiloxParams<4, 32, 10>; ///< Philox algorithm: 10 rounds, 4 numbers of size 32.
            ...
            // TODO: https://en.cppreference.com/w/cpp/named_req/RandomNumberEngine
        };
        ...
        public:
            ...
            EngineVariant engineVariant;
            template <typename TScalar> using ResultContainer = typename EngineVariant::ResultContainer<TScalar>;
        ...
        public:
            ...
            {
                // FIXME: quick hack for 4-vectors, to be changed after API decision.
                auto result = engine();
