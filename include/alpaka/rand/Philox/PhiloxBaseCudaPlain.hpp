        ...
        namespace engine
        {
            ...
            protected:
                ALPAKA_FN_HOST_ACC auto singleRound(Counter const& counter, Key const& key)
                {
                    ...
                    mulhilo32(counter.x, this->MULTIPLITER_4x32_0, H0, L0);
                    mulhilo32(counter.z, this->MULTIPLITER_4x32_1, H1, L1);
                    return Counter{H1 ^ counter.y ^ key.x, L1, H0 ^ counter.w ^ key.y, L0};
                }
